...
# on peer0.telco1 and peer0.telco2, and uprage the chaincode on the
# channel to version 2.0, thus completing the addition of telco3 to the
# network previously setup in the BYFN tutorial.
#

echo
echo "========= Finish adding Telco3 to your first network ========= "
echo
CHANNEL_NAME="$1"
DELAY="$2"
LANGUAGE="$3"
